                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtHinhAnh2" class="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>HÌNH ẢNH 3</label>
                                <asp:TextBox ID="txtHinhAnh3" class="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>HÌNH ẢNH 4</label>
                                <asp:TextBox ID="txtHinhAnh4" class="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
            ...
            <div class="form-group">
                <asp:GridView ID="GridAllStore"  runat="server" AutoGenerateColumns="False" Width="80%"  ViewStateMode="Enabled" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None">
                    <Columns>
                        ...
                        <asp:BoundField DataField="HINH_ANH2" HeaderText="Hình Ảnh 2" />
                        <asp:BoundField DataField="HINH_ANH3" HeaderText="Hình Ảnh 3" />
                        <asp:BoundField DataField="HINH_ANH4" HeaderText="Hình Ảnh 4" />
