...
namespace TeamProject.Admin
{
    public partial class QLCTSP : System.Web.UI.Page
    {
        ...
        protected void btn_Them_Click(object sender, EventArgs e)
        {
            string[] vals = new string[]
                {                
                    txtTen.Text,
                    txtMoTa.Text,
                    txtHinhAnh.Text,txtHinhAnh2.Text,txtHinhAnh3.Text,txtHinhAnh4.Text
                };
        ...
        public void Reset()
        {
            ...
            txtHinhAnh2.Text = null;
            txtHinhAnh3.Text = null;
            txtHinhAnh4.Text = null;
        }
        ...
        protected void bnt_Sua_Click(object sender, EventArgs e)
        {
            string[] vals = new string[]
            {
               ...
               txtMoTa.Text,
               txtHinhAnh.Text,
               txtHinhAnh2.Text,txtHinhAnh3.Text,txtHinhAnh4.Text
             };
            string[] pars = new string[]
            {
                    "ID",
        ...
        protected void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txtHinhAnh2.Text = dt.Rows[0]["HINH_ANH2"] + "";
                txtHinhAnh3.Text = dt.Rows[0]["HINH_ANH3"] + "";
                txtHinhAnh4.Text = dt.Rows[0]["HINH_ANH4"] + "";
            }
        }
